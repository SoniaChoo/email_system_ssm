...
CREATE TABLE `captcha` (
  ...
  `captcha_create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '收件时间',
...
-- Records of captcha
-- ----------------------------
INSERT INTO `captcha` VALUES ('345678905678', '982709437@qq.com', '602232939@qq.com', 'test', 'test', '0', '2020-06-19 10:44:33');
INSERT INTO `captcha` VALUES ('888888888888', '982709437@qq.com', '602232939@qq.com', 'test2', 'test2', '1', '2020-06-19 11:24:11');
INSERT INTO `captcha` VALUES ('9999999999', '982709437@qq.com', '602232939@qq.com', 'test3', 'test3', null, null);
...
CREATE TABLE `invitation` (
  ...
  `invitation_activate_time` timestamp NULL DEFAULT NULL COMMENT '激活时间',
  `invitation_captcha_count` int(11) DEFAULT NULL COMMENT '验证次数',
  `invitation_first_captcha_time` timestamp NULL DEFAULT NULL COMMENT '初次验证时间',
